...
import { LayoutGrid, Users, FileText, Bell, Receipt, Truck, Package, BarChart3, Settings, CalendarDays, Warehouse, Store, ClipboardCheck, Tag, ShieldCheck, Activity } from "lucide-react";
...
const nav = [
  ...
  { to: "/staff", label: "الورديات والموظفين", icon: ShieldCheck },
  { to: "/audit", label: "سجل التدقيق والحركات", icon: Activity },
  { to: "/discounts", label: "الخصومات والولاء", icon: Tag },
